        ...
        <>
            ...
            <div className="form">
                <form onSubmit={handleSubmit}>
                    ...
                    <input type="text" id="company" name="company" value={company} onChange={(event) => setCompany(event.target.value)} />

                    <label htmlFor="logoBackground">Logo Background Color:</label>
                    <input type="text" id="logoBackground" name="logoBackground" value={logoBackground} onChange={(event) => setLogoBackground(event.target.value)} />

                    <label htmlFor="position">Position:</label>
                    <input type="text" id="position" name="position" value={position} onChange={(event) => setPosition(event.target.value)} />

                    <label htmlFor="contract">Contract:</label>
                    <select id="contract" name="contract" value={contract} onChange={(event) => setContract(event.target.value)}>
                    ...
                    <input type="text" id="website" name="website" value={website} onChange={(event) => setWebsite(event.target.value)} />

                    <label htmlFor="apply">Apply:</label>
                    <input type="text" id="apply" name="apply" value={apply} onChange={(event) => setApply(event.target.value)} />
                    ...
                    <textarea id="requirementsContent" name="requirementsContent" value={requirementsContent} onChange={(event) => setRequirementsContent(event.target.value)}></textarea>
