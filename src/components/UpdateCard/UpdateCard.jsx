...
const UpdateCard = () => {
    ...
    function selectElem(selectValue) {
        console.log(selectValue);
        if (selectValue) {
            let elem = document.getElementById("contract");
            ...
            <div className="form">
                <form onSubmit={handleSubmit}>
                    <input
                        ...
                        value={offer.company}
                        onChange={(event) =>
                            setOffer({ ...offer, company: event.target.value })
                        }
                    />
                    ...
                    <input
                        ...
                        id="logoBackground"
                        name="logoBackground"
                        value={offer.logoBackground}
                        onChange={(event) =>
                            setOffer({
                                ...offer,
                                logoBackground: event.target.value,
                            })
                        }
                    />
                    ...
                    <input
                        ...
                        onChange={(event) =>
                            setOffer({ ...offer, position: event.target.value })
                        }
                    />
                    ...
                    <select
                        ...
                        onChange={(event) =>
                            setOffer({
                                ...offer,
                                contract: selectElem(event.target.value),
                            })
                        }
                    >
                    ...
                    <input
                        ...
                        value={offer.website}
                        onChange={(event) =>
                            setOffer({ ...offer, website: event.target.value })
                        }
                    />
                    ...
                    <input
                        ...
                        value={offer.apply}
                        onChange={(event) =>
                            setOffer({ ...offer, apply: event.target.value })
                        }
                    />
                    ...
                    {offer.requirements && (
                        <textarea
                            ...
                            value={offer.requirements.content}
                            onChange={(event) =>
                                setOffer({
                                    requirementsContent: event.target.value,
                                })
                            }
                        ></textarea>
                    )}
                    ...
                    {offer.role && (
                        <textarea
                            id="rolesContent"
                            name="rolesContent"
                            value={offer.role.content}
                            onChange={(event) =>
                                setOffer({
                                    roleContent: event.target.value,
                                })
                            }
                        ></textarea>
                    )}
